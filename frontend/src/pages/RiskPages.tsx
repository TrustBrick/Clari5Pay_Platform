...
function exportComplaintPdf(args: { memberId: string; memberName: string; merchantName: string; bank: BankDetail; description: string; documents: LocalDoc[] }) {
  const w = window.open('', '_blank', 'width=1000,height=800');
  ...
  footer{margin-top:24px;border-top:1px solid #ddd;padding-top:8px;font-size:10px;color:#888;text-align:center}</style></head><body>
  <div class="head"><h1>CYBER CRIME COMPLAINT</h1><p>Filed via Clari5Pay Risk Management · Confidential</p><p>Date: ${now}</p></div>
