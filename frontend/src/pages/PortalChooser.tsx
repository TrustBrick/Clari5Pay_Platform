...
const PortalChooser: React.FC = () => (
  <div style={{ minHeight: '100vh', background: '#0a2540', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 24, boxSizing: 'border-box', fontFamily: "'Inter','Segoe UI',sans-serif" }}>
