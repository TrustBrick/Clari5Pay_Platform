...
import { transactionAPI, supportAPI, supportWsUrl, userAPI, bankAccountAPI, newsAPI, agentAssignmentAPI, fetchAllPages } from '../services/api';
      ...
      <Card>
        <div style={{ padding:'16px 20px',borderBottom:`1px solid ${T.border}`,display:'flex',alignItems:'center',justifyContent:'space-between',gap:12,flexWrap:'wrap' }}>
          ...
          <div style={{ width:260,maxWidth:'100%' }}>
            <Input value={search} onChange={e=>setSearch(e.target.value)} placeholder={byCompany ? 'Search company or reference…' : 'Search Membership ID or member…'} icon="search" style={{ marginBottom:0 }}/>
          </div>
        </div>
