      ...
      {payStep && (
        <div style={{ marginTop:18,paddingTop:16,borderTop:`1px solid ${T.border}` }}>
          ...
          <div style={{ display:'flex',gap:10,marginTop:12 }}>
            <Btn onClick={()=>complete(true)} disabled={saving||(needReceipt&&!receipt)||(needUtr&&!payUtr.trim())||(needsManualAccount&&!payoutAccountRef)||(needsPayout&&payMethod==='MANUAL'&&!manualRef.trim())}>{saving ? 'Saving...' : <><Icon name="approve" size={14} /> Complete</>}</Btn>
            <Btn variant="secondary" onClick={onClose}>Cancel</Btn>
          </div>
        </div>
      )}
