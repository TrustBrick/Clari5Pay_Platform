...
const RequestModal: React.FC<{
  ...
  // Card deposit: the Admin's single action is submitting the payment gateway link generated by
  // company staff (Link Requested → Link Submitted). The final Mark Deposit belongs to the
  // requesting operator, so the Admin's "Mark Deposited" step below is not offered for Card.
  ...
  // own step and is excluded from the account picker.
  ...
  const depositDoneStep = canAct && isDeposit && !isCardDeposit && tx.status === 'SLIP_SUBMITTED'; // review slip → Deposited
